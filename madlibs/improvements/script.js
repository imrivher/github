(function(){
    ...
    myForm.addEventListener('submit', function(e){
        ...
        if(formData[currentInput].value == '' || formData[currentInput].value == NaN){
            ...
            currentInput++;
            counterBtn.innerHTML = `${currentInput+1}/14`;
        }
